...
export default function Answer({ word, soundmark, onToNextStatement }: { word: string, soundmark: string, onToNextStatement: () => void }) {
    ...
    return (
        <div className="text-center mb-20 mt-10">
            <div className="text-5xl mb-3">
                {word}
                <svg className="w-7 h-7 inline-block ml-1 cursor-pointer" onClick={handlePlaySoundmark} viewBox='0 0 1024 1024' version="1.1" xmlns="http://www.w3.org/2000/svg">
                    <path
